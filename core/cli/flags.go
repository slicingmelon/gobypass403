...
func parseFlags() (*CliOptions, error) {
	...
	flags := []multiFlag{
		...
		{name: "m,module", usage: "Bypass module (all, mid_paths, end_paths, http_methods, case_substitution, char_encode,unicode_path_normalization, http_headers_scheme, http_headers_ip, http_headers_port, http_headers_url, http_host)", value: &opts.Module, defVal: "all"},
