...
func parseFlags() (*Options, error) {
	...
	flags := []multiFlag{
		...
		{name: "m,module", usage: "Bypass module (all, mid_paths, end_paths, case_substitution, char_encode, http_headers_scheme, http_headers_ip, http_headers_port, http_headers_url, http_host)", value: &opts.Mode, defVal: "all"},
